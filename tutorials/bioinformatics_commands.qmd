...
echo "Total folders without .gz files: $count"` - to find the number of folder with missing .gz files
...
- `find /path/to/folder -type f | wc -l` - Count the total number of files in a specific folders.
