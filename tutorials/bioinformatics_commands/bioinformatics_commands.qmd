...
subtitle: "Essential Linux, Vim, awk, and HPC commands for genomic data workflows"
description: "A quick-reference guide to the terminal commands used most often when inspecting, filtering, and processing sequencing and variant data."

author: "Nivedita Bhadra"
date: 2025-07-10
image: images/bioinformatics-commands.svg
...
::: {.thesis-hero-wrap}
<img src="images/bioinformatics-commands.svg" alt="Diagram of a terminal running common bioinformatics commands, alongside badges for FASTQ, VCF, BAM, and HPC/SLURM workflows" class="thesis-hero-art"/>
...
::: {.tag-row}
[Linux/Unix Shell]{.tag} [awk]{.tag} [grep]{.tag} [SLURM/HPC]{.tag}
:::
...
### One-Liner: Counting Folders Missing Compressed Files
...
echo "Total folders without .gz files: $count"
```
...
- `srun --time=02:00:00 --mem=8G --cpus-per-task=2 --pty bash` – Start an interactive session on the HPC
...
::: {.tag-row}
[sbatch]{.tag} [tmux]{.tag} [Shell Scripting]{.tag} [QC Automation]{.tag}
:::
